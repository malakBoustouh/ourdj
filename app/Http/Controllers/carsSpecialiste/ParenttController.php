...
class ParenttController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pagecarsspecialiste.parentts.index')->with($arr);
    }
    public function create()
    {
        ...
        return view('pagecarsspecialiste.parentts.create')->with($arr);
    }
    ...
    public function show($enfant_id)
    {
        ...
        return view('pagecarsspecialiste.parentts.show', compact('parentt'),compact('enfant'));
    }
    ...
    public function edit(Parentt $parentt)
    {
        ...
        return view('pagecarsspecialiste.parentts.edit',compact('parentt'))->with($arr);
    }
    ...
    public function update(Request $request,Parentt $parentt)
    {
        ...
        return redirect()->route('pagecarsspecialiste.$parentts.index')->with('success','تمت عملية التعديل بنجاح ');
    }
    ...
    public function destroy(Parentt $parentt)
    {
        ...
        //$traitant->delete();
        return redirect()->route('pagecarsspecialiste.parentts.index')->with('success','تمت عملية الحذف بنجاح '); ;
    }
    /**
